...
import com.org.enotesapiservice.repository.FavouriteNoteRepository;
...
public class NotesServiceImpl implements NotesService {
    ...
    private void updateNotes(NotesDto notesDto, MultipartFile file) {
        Notes existNotes = notesRepository
                .findById(notesDto.getId())
                .orElseThrow(() -> new ResourceNotFoundException("notes is invalid "));
...
//        return notes;
    ...
    @Override
    public NotesResponse getAllNotesByUserSearch(Integer pageNumber, Integer pageSize,String keyword) {
        Integer userId = CommonUtil.getLoggedInUser().getId();
        Pageable pageable = PageRequest.of(pageNumber, pageSize);
    ...
    @Override
    public Boolean copyNotes(Integer id) {
        ...
        Notes copyNotes = Notes.builder()
                ...
                .fileDetails(null)
                .build();
        Notes saveCopyNote = notesRepository.save(copyNotes);
